...
Future<bool?> showReportCardOperationDialog({
...
class _ReportCardOperationDialog extends StatefulWidget {
  ...
  const _ReportCardOperationDialog({
  ...
  @override
  State<_ReportCardOperationDialog> createState() =>
      _ReportCardOperationDialogState();
}

enum _ReportCardDialogPhase { loading, success, error }

class _ReportCardOperationDialogState extends State<_ReportCardOperationDialog>
    with TickerProviderStateMixin {
  late final AnimationController _pulseController;
  late final AnimationController _dotsController;

  _ReportCardDialogPhase _phase = _ReportCardDialogPhase.loading;
  ...
  Future<void> _runOperation() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _phase = _ReportCardDialogPhase.success;
      });
      ...
      if (!mounted) return;
      setState(() {
        _phase = _ReportCardDialogPhase.error;
  ...
  Widget build(BuildContext context) {
    ...
    final palette = _ReportCardDialogPalette(isDark: isDark);
    final indicatorColor = switch (_phase) {
      _ReportCardDialogPhase.loading => palette.accentBlue,
      _ReportCardDialogPhase.success => palette.accentGreen,
      _ReportCardDialogPhase.error => palette.accentRed,
    };
  ...
  Widget _buildBody({
    required Key key,
    required _ReportCardDialogPalette palette,
    required Color indicatorColor,
  }) {
    switch (_phase) {
      case _ReportCardDialogPhase.loading:
        return _LoadingBody(
          key: key,
          palette: palette,
          indicatorColor: indicatorColor,
      ...
      case _ReportCardDialogPhase.success:
        return _SuccessBody(
          key: key,
          palette: palette,
          indicatorColor: indicatorColor,
      ...
      case _ReportCardDialogPhase.error:
        return _ErrorBody(
          key: key,
          palette: palette,
          indicatorColor: indicatorColor,
...
class _LoadingBody extends StatelessWidget {
  final _ReportCardDialogPalette palette;
        ...
        Row(
          children: [
            _StatusIcon(
              ...
              icon: PhosphorIcons.floppy_disk,
              palette: palette,
            ),
            SizedBox(width: 16.w),
            Expanded(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      detail ?? 'Processando informações do boletim...',
                      style: GoogleFonts.inter(
                        fontSize: 13.2.sp,
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      'Não feche esta janela enquanto a operação termina.',
                      style: GoogleFonts.inter(
                        fontSize: 11.8.sp,
                        fontWeight: FontWeight.w500,
                        color: palette.muted,
...
class _ReportCardDialogPalette {
  final bool isDark;

  _ReportCardDialogPalette({required this.isDark});
