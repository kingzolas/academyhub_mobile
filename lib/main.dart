...
import 'package:academyhub_mobile/providers/offline_sync_provider.dart';
...
import 'package:academyhub_mobile/widgets/app_update_banner.dart';
import 'package:academyhub_mobile/widgets/app_update_diagnostics_screen.dart';
import 'package:academyhub_mobile/widgets/offline_sync_banner.dart';
...
class MyApp extends StatelessWidget {
  ...
  static final GoRouter _router = GoRouter(
    ...
    routes: [
      GoRoute(
        path: '/support/update-diagnostics',
        builder: (context, state) => const AppUpdateDiagnosticsScreen(),
      ),
      GoRoute(
